...
import nukeeng.main.blocks.rtg.models.ModelRTG_IEU1;

public class RenderTableRTG_IEU1 extends TileEntitySpecialRenderer {
	private ModelRTG_IEU1 RTG_IEU1;

	public RenderTableRTG_IEU1() {
		RTG_IEU1 = new ModelRTG_IEU1();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.RTG_IEU1.blockID) {
		...
		bindTextureByName("/nukeeng/textures/RTG_IEU-1.png");
		RTG_IEU1.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
