...
public class RTG_IEU1 extends BlockContainer {
	public static final String name = "RTG_IEU1";

	public RTG_IEU1(int id, int texture) {
		super(id, Material.iron);
		setHardness(0.6F);
		setResistance(0.6F);
		setStepSound(Block.soundMetalFootstep);
		setCreativeTab(CreativeTab.tabNukeEngMain);
		setBlockName("RTG_IEU1");
		blockIndexInTexture = 147;
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLiving entity) {
		if ((entity instanceof EntityPlayer)) {
			...
			world.setBlockAndMetadataWithNotify(x, y, z, Blocks.RTG_IEU1.blockID, facing / 2);
		}
	}
