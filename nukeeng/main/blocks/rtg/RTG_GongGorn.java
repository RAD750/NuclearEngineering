...
public class RTG_GongGorn extends BlockContainer {
	public static final String name = "RTG_GongGorn";

	public RTG_GongGorn(int id, int texture) {
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLiving entity) {
		if ((entity instanceof EntityPlayer)) {
			...
			world.setBlockAndMetadataWithNotify(x, y, z, Blocks.RTG_GongGorn.blockID, facing / 2);
		}
	}
	...
	public TileEntity createTileEntity(World world, int meta) {
		return new TileEntityRTG_GongGorn();
	}
}